...
function InfoSection({trip}) {
  return (
    <div>
        <img src='/air.jpg'className = 'h-[340px] w-full object-cover rounded-xl'/>
        ...
        <div className='flex justify-between items-center'>
            <div className='my-5 flex flex-col gap-2'>
              ...
              <div className='flex gap-5'>
                ...
                <h2 className='p-1 px-3 bg-gray-200 rounded-lg text-gray-500 text-xs md:text-md'> 🥂 no. of treveler:
